(function () {
  ...
  const translations = {
    en: {
      ...
      'hero.cta1': 'Design your process architecture →',
      'hero.cta2': 'View solutions',
      'hero.stat1.label': 'years in B2B & industry',
      'hero.stat2.label': 'years in processes & reengineering',
      'hero.stat3.label': 'automations in production',

      'badges.label': 'We integrate advanced technology into the tools you already use',

      'solutions.tag': 'What we solve',
      'solutions.title': 'Six processes most SMBs sustain with hours of manual work. Six systems that run them on their own.',
      'solutions.desc': 'Prospecting, customer support, operations: the three pillars companies sustain with hours of work. We redesign and automate them with engineering rigor — on your existing tools, with your team supervising.',
      'solutions.cta': 'Ready to automate? →',
      ...
      'features.1.title': 'From idea to functional architecture in days',
      'features.1.desc': 'Kaizen methodology and agile execution. No 6-month projects. We go from brief to integrated system in weeks, not months.',
      'features.2.title': 'Always processes before code',
      'features.2.desc': 'B2B flows, sales, procurement, operations. We map and optimize before deploying. AI only amplifies well-designed processes.',
      'features.3.title': 'Built for you, not another subscription',
      'features.3.desc': 'Every solution is configured around how you actually work: connected to your systems, documents, and rules — not another off-the-shelf program.',
      ...
      'blog.2.title': 'What will tomorrow\'s CEOs need to look like?',
      'blog.2.desc': 'Until now, knowing the business and people was enough — but future leaders will also need deep technology fluency…',
    ...
    es: {
      ...
      'hero.cta1': 'Diseña tu arquitectura de procesos →',
      'hero.cta2': 'Ver soluciones',
      'hero.stat1.label': 'años en B2B e industria',
      'hero.stat2.label': 'años en procesos y reingeniería',
      'hero.stat3.label': 'automatizaciones en producción',

      'badges.label': 'Integramos tecnología avanzada en las herramientas que ya usas',

      'solutions.tag': 'Lo que resolvemos',
      'solutions.title': 'Seis procesos que en la mayoría de pymes se sostienen a base de horas. Seis sistemas que los ejecutan solos.',
      'solutions.desc': 'Prospección, atención al cliente, operaciones: los tres pilares que las empresas sostienen a base de horas. Los rediseñamos y los automatizamos con criterio de ingeniería — sobre las herramientas que ya usas y con tu equipo supervisando.',
      'solutions.cta': '¿Listos para automatizar? →',
      ...
      'features.1.title': 'De idea a arquitectura funcional en días',
      'features.1.desc': 'Metodología Kaizen y ejecución ágil. No proyectos de 6 meses. Pasamos de brief a sistema integrado en semanas, no meses.',
      'features.2.title': 'Siempre procesos antes que código',
      'features.2.desc': 'Flujos B2B, ventas, compras, operaciones. Mapeamos y optimizamos antes de desplegar. La IA amplifica sólo procesos bien diseñados.',
      'features.3.title': 'Hecho a tu medida, no a la de un programa más',
      ...
      'blog.2.title': '¿Cómo tendrán que ser l@s CEO\'s del futuro?',
      'blog.2.desc': 'Hasta ahora, con saber mucho del negocio y personas ya era suficiente; pero los líderes del futuro tendrán que saber MUCHO también de tecnología…',
